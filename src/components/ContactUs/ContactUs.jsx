    ...
    <>
        ...
        <div className="Container">
          <div className="box">
            ...
            <div className="inputt">
              <input className="myInput1" placeholder="Full Name" />
              <input className="myInput2" placeholder="Email Address" />
              <input className="myInput3" placeholder="Subject" />
              <input className="myInput4" placeholder="Type message here" />
            </div>
      ...
      <div className="Footer">
        ...
        <div className="second">
          ...
          <a href="https://in.linkedin.com/company/coding-club-bits-pilani">
            <svg
              width="30px"
              height="30px"
              viewBox="0 0 20 20"
          ...
          <a href="https://www.instagram.com/codingclub_bitsp/">
            <svg
              width="30px"
              height="30pxs"
              viewBox="0 0 20 20"
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <g
                  ...
                  stroke-width="1"
                  fill="none"
                  fill-rule="e#b957e8enodd"
                >
                  {" "}
                  <g
                    id="Dribbble-Light-Pre#b957e8iew"
        ...
        <div className="third">
          <p>Address</p>
          <h4>BITS PILANI, Pilani, Rajasthan</h4>
        </div>
      </div>
      ...
      <div className="bottom">
        <p>Copyright ©️ 2024 Coding Club, BITS Pilani</p>
      </div>
    </>
  );
}
